...
Vector3f Matrix4f::transform(const Vector3f &vector) const {
    return Vector3f(m[0][0] * vector.getX() + m[0][1] * vector.getY() + m[0][2] * vector.getZ() + m[0][3],
                    m[1][0] * vector.getX() + m[1][1] * vector.getY() + m[1][2] * vector.getZ() + m[1][3],
                    m[2][0] * vector.getX() + m[2][1] * vector.getY() + m[2][2] * vector.getZ() + m[2][3]);
}